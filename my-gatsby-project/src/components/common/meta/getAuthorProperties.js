...
export const getAuthorProperties = (primaryAuthor) => {
    ...
    authorProfiles.push(
        ...
        primaryAuthor.twitter ? `https://twitter.com/$` : null,
        primaryAuthor.facebook ? `https://www.facebook.com/` : null
    )
    ...
    return {
        ...
        facebookUrl: primaryAuthor.facebook ? `https://www.facebook.com` : null,
    }
}
